    ...
    def __str__(self):
        if self.label == "Background":
            ...
            {} Application:
                    ...
                    Outgoing Info: {}
                    Is malicious: {}
            """.format(self.label, self.method, self.user_agent, self.ip_dsts, self.constant_header_fields,
                       self.avg_size, self.outgoing_info, self.is_malicious == '1')
        else:
            return """
            {} Application:
                    Method: {}
                    ...
                    Outgoing Info: {}
                    Is malicious: {}
            """.format(self.label, self.method, self.user_agent, self.ip_dsts, self.language, self.outgoing_info,
                       self.is_malicious == '1')
