...
var grandin = function(){
    $(".clock-runtime").replaceWith("<span class=\"counter-anim clock-runtime\">"+"1000"+"</span>");
    $(".flow-counter").replaceWith("<span class=\"counter-anim flow-counter\">"+"2000"+"</span>");
    $(".software-counter").replaceWith("<span class=\"counter-anim software-counter\">"+"3000"+"</span>");
    $(".malware-counter").replaceWith("<span class=\"counter-anim malware-counter\">"+"4000"+"</span>");
